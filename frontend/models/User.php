...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function followUser(User $user)
    {
        ...
        $redis = Yii::$app->redis;
        $redis->sadd("user:{$this->getId()}:subscriptions", $user->getId()); //current user
        $redis->sadd("user:{$user->getId()}:followers", $this->getId()); //user from profileController
    }
    ...
    public function unfollowUser(User $user)
    {
        ...
        $redis = Yii::$app->redis;
        $redis->srem("user:{$this->getId()}:subscriptions", $user->getId()); //current user
        $redis->srem("user:{$user->getId()}:followers", $this->getId()); //user from profileController
    }
    ...
    public function getMuturalSubscriptionsTo(User $user)
    {
        //Current user subscritions
